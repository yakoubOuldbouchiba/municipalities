...
const OrganizationClaimForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.post('/claims/organization', formDataToSend, {
        headers: {
    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="p-fluid">
        <div style={{ marginBottom: '1rem' }}>
          <label htmlFor="company">{t('claims.organizationName')} *</label>
          <InputText
            id="company"
            name="company"
...
export default OrganizationClaimForm;
