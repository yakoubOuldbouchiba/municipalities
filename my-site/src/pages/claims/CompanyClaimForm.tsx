...
const CompanyClaimForm: React.FC = () => {
  ...
  const handleFileSelect = (e: any) => {
    ...
    setFiles(prev => [...prev, ...newFiles] as File[]);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.post('/claims/company', formDataToSend, {
        headers: {
    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="p-fluid">
        <div style={{ marginBottom: '1rem' }}>
          <label htmlFor="company">{t('claims.companyName')} *</label>
          <InputText
            id="company"
            name="company"
        ...
        <div style={{ marginBottom: '1rem' }}>
          <label htmlFor="register_number">{t('claims.registerNumber')} *</label>
          <InputText
            id="register_number"
