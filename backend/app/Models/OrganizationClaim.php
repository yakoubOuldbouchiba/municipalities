...
class OrganizationClaim extends Model implements Auditable
{
    ...
    /**
     * Scope to get claims by company
     */
    ...
    /**
     * Check if company has reached rate limit (3 claims)
     */
    public static function hasReachedRateLimit($company)
    {
        return self::byCompany($company)->count() >= 3;
    }
